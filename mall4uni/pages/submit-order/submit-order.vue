  ...
  <view class="submit-order">
    ...
    <view class="prod-item">
      ...
      <view class="total-num">
        <text class="prodcount">共{{totalCount}}件</text>
        <view class="prodprice">合計：
...
<!--      <view class="msg-item">
        <view class="item coupon" @tap="showCouponPopup">
          <text class="item-tit">優惠劵：</text>
          <text class="item-txt" v-if="!coupons.canUseCoupons">暫無可用</text>
          <text class="coupon-btn">{{coupons.totalLength? coupons.totalLength: 0}}張</text>
...
<view class="popup-hide" v-if="popupShow">
  <view class="popup-box">
    ...
    <view class="coupon-ok" v-if="couponSts==1">
      <text @tap="choosedCoupon">確定</text>
    </view>
  </view>
</view>
</view>
