<template>
  <div class="mod-prod-info">
    <el-form :model="dataForm"
      ...
      <el-form-item label="產品分类"
                    :rules="[{ required: true, message: '请选择產品分类'}]"
                    prop="categoryId">
        <el-col :span="8">
      ...
      <el-form-item label="產品分组" :rules="[{ required: true, message: '请选择產品分组'}]">
        <el-col :span="8">
      ...
      <el-form-item label="產品名稱"
                    prop="prodName"
                    :rules="[
                      { required: true, message: '產品名称不能为空'},
                      { pattern: /\s\S+|S+\s|\S/, message: '請輸入正確的產品名稱', trigger: 'blur' }
                    ]">
        <el-col :span="8">
      ...
      <el-form-item label="產品卖点"
                    prop="brief"
                    :rules="[
                      { required: false, pattern: /\s\S+|S+\s|\S/, message: '請輸入正確的產品賣點', trigger: 'blur' }
                    ]">
        <el-col :span="8">
          <el-input v-model="dataForm.brief"
                    type="textarea"
                    :autosize="{minRows: 2, maxRows: 4}"
                    placeholder="產品賣點"></el-input>
        </el-col>
      </el-form-item>
      <el-form-item label="配送方式">
        <el-checkbox v-model="dataForm.deliveryMode.hasShopDelivery">商家配送</el-checkbox>
        <el-checkbox v-model="dataForm.deliveryMode.hasUserPickUp">用戶自提</el-checkbox>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary"
                   @click="dataFormSubmit()">確定</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
