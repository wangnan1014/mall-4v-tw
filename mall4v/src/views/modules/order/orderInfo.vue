            ...
            <div class="num-cont">
              ...
              <el-form-item>
                <el-steps :active="stepsStatus" align-center :process-status="dataForm.status == 6 ? 'error':'wait'">
                  <el-step title="提交訂單" :description="dataForm.orderTime"></el-step>
                  <el-step title="买家已付款" :description="dataForm.payTime"></el-step>
                  <el-step title="卖家已發貨" v-if="dataForm.orderType !== 1" :description="dataForm.dvyTime"></el-step>
              ...
              <div class="state-title">
                <el-form-item label="訂單狀態:">
                  <template slot-scope="scope">
                    ...
                    <el-tag v-if="dataForm.status === 2 && dataForm.orderType !== 1" size="small" type="warning">待發貨</el-tag>
                ...
                <el-form-item>
                  <el-row>
                    <el-button type="primary" v-if="dataForm.status === 2 && dataForm.orderType !== 1" plain @click="changeOrder(dataForm.orderNumber)">發貨</el-button>
              ...
              <div class="order-info">
                <div class="order-details">
                  <div class="detail-title">
                    ...
                    <span class="prompt">买家付款后才可以發貨</span>
                  </div>
          ...
          <div class="order-log">
            ...
            <div class="log-cont">
              <el-form-item v-if="dataForm.orderTime" label-width="10px">
                <span>{{dataForm.orderTime}} {{dataForm.nickName}} 创建訂單（成功）</span>
              </el-form-item>
              <el-form-item v-if="dataForm.updateTime" label-width="10px">
                <span>{{dataForm.updateTime}} {{dataForm.nickName}} 訂單更新（成功）</span>
              </el-form-item>
              <el-form-item v-if="dataForm.payTime" label-width="10px">
                <span>{{dataForm.payTime}} {{dataForm.nickName}} 訂單付款（成功）</span>
              </el-form-item>
              <el-form-item v-if="dataForm.dvyTime" label-width="10px">
                <span>{{dataForm.dvyTime}} {{dataForm.nickName}} 訂單發貨（成功）</span>
              </el-form-item>
              <el-form-item v-if="dataForm.finallyTime" label-width="10px">
                <span>{{dataForm.finallyTime}} {{dataForm.nickName}} 完成訂單（成功）</span>
              </el-form-item>
              <el-form-item v-if="dataForm.cancelTime" label-width="10px">
                <span>{{dataForm.cancelTime}} {{dataForm.nickName}} 取消訂單（成功）</span>
              </el-form-item>
            </div>
          </div>
        </div>
