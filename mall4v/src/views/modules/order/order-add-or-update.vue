        ...
        <div class="main">
            <div class="content">
                ...
                <div class="order-number">
                    <div class="num-cont">
                        <span class="number-text">訂單編號：</span>
                        <span class="text">007007007007007</span>
                        <div class="steps">
                                <el-steps :active="2" align-center>
                                    <el-step title="提交訂單" description="2018/11/2 18:06:22"></el-step>
                                    <el-step title="买家已付款" description="2018/11/2 18:06:22"></el-step>
                                    <el-step title="卖家已發貨" description="2018/11/2 18:06:22"></el-step>
                ...
                <div class="order-state">
                    <div class="state-cont">
                        ...
                        <div class="state-title">
                            ...
                            <span class="text">，如果客户不付款訂單自动关闭</span>
                            </span>
                            ...
                            <div class="buyers">
                                ...
                                <div class="buyers-info">
                                    <div class="detail02">
                                        ...
                                        <div class="text-width">
                                            <span>买家備注：</span>
                                            <span class="revise-remarks" onclick="window.location.href='#'"><img src="~@/assets/img/revise.png"  alt="">修改備注</span>
                                            <br>
                        ...
                        <div class="item-info">
                            ...
                            <span>应付金額：<span class="amount text">￥15.00</span></span>
                        </div>
                         <!-- 价格详情end -->
                    </div>
                </div>
                ...
                <div class="order-log">
                    ...
                    <div class="log-cont">
                        <div>2018-11-2 14:19:00 13726888888 创建訂單（成功）</div>
                        <div>2018-11-2 14:19:00 13726888888 创建訂單（成功）</div>
                    </div>
                </div>
                <!-- 訂單日志end -->
