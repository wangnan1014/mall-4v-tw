...
<view class="container">
  <view v-if="sts == 0">
    <view class="pay-sts fail">支付失敗</view>
    <view class="tips">請在
      <text class="warn">30分鐘</text>内完成付款</view>
    <view class="tips">否者訂單會被系統取消</view>
    <view class="btns">
      <text class="button checkorder" @tap="toOrderList">查看訂單</text>
      <text class="button payagain" @tap="payAgain">重新支付</text>
    </view>
  </view>

  <view v-if="sts == 1">
    <view class="pay-sts succ">訂餐成功</view>
    <view class="tips">感謝您的訂餐</view>
    <view class="btns">
      <text class="button checkorder" @tap="toOrderList">查看訂單</text>
      <text class="button shopcontinue" @tap="toIndex">繼續訂餐</text>
    </view>
  </view>
