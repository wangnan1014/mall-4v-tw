        ...
        <el-table-column header-align="center"
          ...
          <template slot-scope="scope">
            ...
            <el-button v-if="isAuth('shop:transfee:update') && scope.$index > 0"
                       type="text"
                       size="small"
                       @click="addOrUpdateHandle(`${scope.$index}`)">編輯</el-button>
        ...
        <el-table-column header-align="center"
          ...
          <template slot-scope="scope">
            ...
            <el-button v-if="isAuth('shop:transfee:update')"
                       type="text"
                       size="small"
                       @click="addOrUpdateTransfeeFree(`${scope.$index}`)">編輯</el-button>
        ...
        <el-table-column header-align="center"
          ...
          <template slot-scope="scope">
            <el-radio-group v-model="scope.row.freeType">
              ...
              <el-radio :label="1">满金額包邮</el-radio>
              <el-radio :label="2">满件/重量/体积且满金額包邮</el-radio>
            </el-radio-group>
          </template>
        </el-table-column>
        <el-table-column header-align="center"
