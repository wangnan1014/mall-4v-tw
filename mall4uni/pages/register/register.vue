			...
			<view class="login-form">
				<view :class="['item',errorTips==1? 'error':'']">
					<view class="account">
						...
						<input type="text" @input="getInputVal" data-type="account" placeholder-class="inp-palcehoder" placeholder="请输入工號名称"></input>
					</view>
					<view class="error-text" v-if="errorTips==1"><text class="warning-icon">!</text>请输入工號！</view>
				</view>
				...
				<view class="operate">
					<view class="to-register" @tap="toLogin">已有工號？<text>去登錄></text></view>
				</view>
			</view>

			<view>
				<button class="authorized-btn" @tap="toRegister">注冊</button>
